        ...
        const query = `
            WITH pagos_mes AS (
                ...
                SELECT
                    ...
                    ms.fecha_pago AS fecha,
                    ms.precio + ms.monto_mora AS monto,
                    ms.id_mensualidad AS id_ref,
                    r.id_recibo
                FROM grupo6_pago_alumnos.mensualidad ms
                         JOIN grupo6_pago_alumnos.forma_pago fp
                              ON fp.id_forma_pago = ms.id_forma_pago
                         LEFT JOIN grupo6_pago_alumnos.recibos r
                                   ON r.id_referencia = ms.id_mensualidad
                                       AND r.tipo_referencia = 'Mensualidad'
                                       AND r.carnet = ms.carnet
